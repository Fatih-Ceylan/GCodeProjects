...
namespace Platform.Api.Controllers.Definitions
{
    ...
    public class CompanyController : ControllerBase
    {
        ...
        public async Task<IActionResult> Create([FromForm] CreateCompanyRequest request)
        {
            ...
            return Ok(_companyService.Create(request, HttpContext.Request.Headers["Authorization"]));
        }
        ...
        {
            return Ok(_companyService.Delete(request, HttpContext.Request.Headers["Authorization"]));
        }
