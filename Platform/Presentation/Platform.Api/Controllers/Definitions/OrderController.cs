...
namespace Platform.Api.Controllers.Definitions
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        readonly IOrderService _gCardOrderService;
        public OrderController(IMediator mediator, IOrderService orderService)
        {
            _mediator = mediator;
            _gCardOrderService = orderService;
        }
        ...
        public async Task<IActionResult> UpdateOrderStatus([FromBody] UpdateOrderStatusRequest request)
        {
            ...
            await _gCardOrderService.UpdateOrderStatus(request.OrderIdFromModule, request.OrderStatus);
            response.MessageList.Add("Updated order status for the GCard module.");
