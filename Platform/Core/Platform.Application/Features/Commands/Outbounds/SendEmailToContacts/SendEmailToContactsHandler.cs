...
namespace Platform.Application.Features.Commands.Outbounds.SendEmail
{
    public class SendEmailToContactsHandler : IRequestHandler<SendEmailToContactsRequest, SendEmailToContactsResponse>
    {
        ...
        {
            var mailCredantial = await _mailService.GetStaticMailCredantial();
        ...
        public async Task<string> SendEMailAsync(MailCredantialDTO mailCredantial, MailOptionDTO mailOption, string body, string subject)
        {
            ...
            mail.Append("<img src=\"http://10.0.0.55:5000/GModule-Files/gcloud.png\" width=\"200\" height=\"150\" alt=\"Şirket Logosu\"><br>");
            mail.Append("GCloud firmamızın bir ürünüdür.<br>");
