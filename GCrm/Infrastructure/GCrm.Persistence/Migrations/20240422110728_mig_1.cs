    ...
    public partial class mig_1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerActivityKinds", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "CustomerActivityStatuses",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerActivityStatuses", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "CustomerActivityTypes",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerActivityTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerKinds", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerKindId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivityAddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerActivities_CustomerActivityKinds_CustomerActivityKindId",
                        column: x => x.CustomerActivityKindId,
                        principalTable: "CustomerActivityKinds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerActivities_CustomerActivityStatuses_CustomerActivityStatusId",
                        column: x => x.CustomerActivityStatusId,
                        principalTable: "CustomerActivityStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerActivities_CustomerActivityTypes_CustomerActivityTypeId",
                        column: x => x.CustomerActivityTypeId,
                        principalTable: "CustomerActivityTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DecisionStatusId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RelationWithCompanyId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerCustomerCategory", x => new { x.CustomerCategoriesId, x.CustomersId });
                    table.ForeignKey(
                        name: "FK_CustomerCustomerCategory_CustomerCategories_CustomerCategoriesId",
                        column: x => x.CustomerCategoriesId,
                        principalTable: "CustomerCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerCustomerCategory_Customers_CustomersId",
            ...
            migrationBuilder.CreateTable(
                name: "CustomerActivityCustomerActivityFile",
                columns: table => new
                {
                    CustomerActivitiesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CustomerActivityFilesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerActivityCustomerActivityFile", x => new { x.CustomerActivitiesId, x.CustomerActivityFilesId });
                    table.ForeignKey(
                        name: "FK_CustomerActivityCustomerActivityFile_AppFiles_CustomerActivityFilesId",
                        column: x => x.CustomerActivityFilesId,
                        principalTable: "AppFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerActivityCustomerActivityFile_CustomerActivities_CustomerActivitiesId",
                        column: x => x.CustomerActivitiesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerActivities_CustomerActivityKindId",
                table: "CustomerActivities",
                column: "CustomerActivityKindId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerActivities_CustomerActivityStatusId",
                table: "CustomerActivities",
                column: "CustomerActivityStatusId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerActivities_CustomerActivityTypeId",
                table: "CustomerActivities",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerActivityCustomerActivityFile_CustomerActivityFilesId",
                table: "CustomerActivityCustomerActivityFile",
                column: "CustomerActivityFilesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerCustomerCategory_CustomersId",
                table: "CustomerCustomerCategory",
                column: "CustomersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_CustomerKindId",
                table: "Customers",
                column: "CustomerKindId");

            migrationBuilder.CreateIndex(
                name: "IX_Customers_CustomerSectorId",
                table: "Customers",
                column: "CustomerSectorId");

            migrationBuilder.CreateIndex(
                name: "IX_Customers_CustomerSourceId",
                table: "Customers",
