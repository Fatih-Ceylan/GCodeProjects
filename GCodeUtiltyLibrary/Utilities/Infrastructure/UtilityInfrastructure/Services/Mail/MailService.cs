...
namespace Utilities.Infrastructure.UtilityInfrastructure.Services.Mail
{
    public class MailService : IMailService
    {
        ...
        public async Task<MailCredantialDTO> GetStaticMailCredantial()
        {
            MailCredantialDTO mailCredantial = new();
        ...
        public async Task<string> SendEMmailAsync(MailCredantialDTO mailCredantial, MailOptionDTO mailOption)
        {
            try
            {
