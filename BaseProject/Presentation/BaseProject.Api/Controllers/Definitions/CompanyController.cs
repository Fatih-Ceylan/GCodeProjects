...
using BaseProject.Application.Features.Queries.Definitions.Company.GetMailCredantialsByCompanies;
using MediatR;
...
namespace BaseProject.Api.Controllers.Definitions
{
    ...
    public class CompanyController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetMailCredantialsByCompanies([FromQuery] GetMailCredantialsByCompaniesRequest request)
        {
            GetMailCredantialsByCompaniesResponse response = await _mediator.Send(request);
            return Ok(response);
        }
