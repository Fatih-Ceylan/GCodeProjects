...
namespace BaseProject.Application.Models
{
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<CreateMailCredantialRequest, MailCredantial>().ReverseMap();
            CreateMap<MailCredantial, CreateMailCredantialResponse>().ReverseMap();
            CreateMap<UpdateMailCredantialRequest, MailCredantial>().ReverseMap();
            CreateMap<MailCredantial, UpdateMailCredantialResponse>().ReverseMap();
            CreateMap<MailCredantial, MailCredantialDTO>().ReverseMap();
            #endregion
