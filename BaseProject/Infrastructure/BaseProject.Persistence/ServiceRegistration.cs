...
namespace BaseProject.Persistence
{
    public static class ServiceRegistration
    {
        public static void AddBaseProjectPersistenceServices(this IServiceCollection services)
        {
            ...
            services.AddScoped<IMailCredantialReadRepository, MailCredantialReadRepository>();
            services.AddScoped<IMailCredantialWriteRepository, MailCredantialWriteRepository>();
