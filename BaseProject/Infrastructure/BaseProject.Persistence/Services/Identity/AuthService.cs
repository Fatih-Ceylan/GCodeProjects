...
namespace BaseProject.Persistence.Services.Identity
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<LoginResponseDTO> LoginAsync(LoginRequestDTO model)
        {
            ...
            {
                TokenDTO token = _tokenHandler.CreateAccessToken(Convert.ToInt32(_config["TokenLifeTime:AccessTokenLifeTime"]), appUser, model.UrlPath,model.MasterCompanyIdFromPlatform);
        ...
        public async Task<LoginResponseDTO> RefreshTokenLoginAsync(string refreshToken, string urlPath, string masterCompanyIdFromPlatform)
        {
            ...
            {
                TokenDTO tokenDTO = _tokenHandler.CreateAccessToken(Convert.ToInt32(_config["TokenLifeTime:AccessTokenLifeTime"]), appUser, urlPath,masterCompanyIdFromPlatform);
        ...
        public async Task PasswordResetAsync(string email)
        {
           AppUser appUser = await _userManager.FindByEmailAsync(email);
            if (appUser != null)
            {
                ...
                var mailCredantialDto = _mapper.Map<MailCredantialDTO>(mailCredantial);
                MailOptionDTO mailOption = new();

                ResetPasswordDTO resetPassword = new();

                resetPassword.MailCredantial = mailCredantialDto;
        ...
        public async Task SendPasswordResetMailAsync(ResetPasswordDTO resetPassword)
        {
            ...
            mail.Append("<img src=\"http://10.0.0.55:5000/Company-Files/olcerholdinglogo.jpg\" width=\"200\" height=\"150\" alt=\"Şirket Logosu\"><br><h2>");
            ...
            await _mailService.SendEMmailAsync(resetPassword.MailCredantial, resetPassword.MailOption);
        }
