...
namespace BaseProject.Persistence.Migrations
{
    ...
    [Migration("20240718064505_mig_21_GCrm")]
    partial class mig_21_GCrm
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomerContactOpportunity", b =>
                {
                    b.Property<Guid>("CustomerContactsId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("OpportunitiesId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("CustomerContactsId", "OpportunitiesId");

                    b.HasIndex("OpportunitiesId");

                    b.ToTable("CustomerContactOpportunity");
                });
            ...
            modelBuilder.Entity("CustomerContactOpportunity", b =>
                {
                    b.HasOne("BaseProject.Domain.Entities.GCrm.Definitions.CustomerManagement.Contacts.CustomerContact", null)
                        .WithMany()
                        .HasForeignKey("CustomerContactsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
