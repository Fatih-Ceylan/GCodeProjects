...
using GCard.Application.Features.Commands.Definitions.SocialMediaUrl.Delete;
using GCard.Application.Features.Commands.Definitions.SocialMediaUrl.Update;
using GCard.Application.Features.Queries.Definitions.SocialMediaUrl.GetAll;
using GCard.Application.Features.Queries.Definitions.SocialMediaUrl.GetById;
using MediatR;
