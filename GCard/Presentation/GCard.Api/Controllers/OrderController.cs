...
using GCard.Application.Features.Commands.Definitions.Order.Delete;
using GCard.Application.Features.Commands.Definitions.Order.Update;
using GCard.Application.Features.Queries.Definitions.Order.GetAll;
using GCard.Application.Features.Queries.Definitions.Order.GetById;
using GCard.Application.Features.Queries.Definitions.Order.GetDetailedListById;
using GCard.Application.Features.Queries.Definitions.Order.GetDetailedListByStatus;
