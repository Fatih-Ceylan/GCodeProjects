...
using GCard.Application.Features.Commands.Definitions.StaffField.Delete;
...
using GCard.Application.Features.Queries.Definitions.StaffField.GetAll;
using GCard.Application.Features.Queries.Definitions.StaffField.GetAllFieldByStaffId;
using GCard.Application.Features.Queries.Definitions.StaffField.GetById;
using MediatR;
