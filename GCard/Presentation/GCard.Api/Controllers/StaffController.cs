...
using GCard.Application.Features.Commands.Definitions.Staff.Delete;
...
using GCard.Application.Features.Commands.Identity.Staff.ConfirmVerificationCode;
...
using GCard.Application.Features.Queries.Definitions.Staff.GetAll;
using GCard.Application.Features.Queries.Definitions.Staff.GetAllRelatedListByStaffId;
using GCard.Application.Features.Queries.Definitions.Staff.GetById;
using GCard.Application.Features.Queries.Definitions.Staff.GetByIdStaffInfo;
using GCard.Application.Features.Queries.Definitions.Staff.MobileGetByIdStaffInfo;
using MediatR;
