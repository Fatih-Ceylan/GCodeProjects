...
using GCard.Application.Features.Commands.Definitions.StaffFile.Delete;
using GCard.Application.Features.Queries.Definitions.StaffFile.GetById;
using GCard.Application.Features.Queries.Definitions.StaffFile.GetFileListByStaffId;
using MediatR;
