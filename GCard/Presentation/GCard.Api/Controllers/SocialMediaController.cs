...
using GCard.Application.Features.Commands.Definitions.SocialMedia.Delete;
using GCard.Application.Features.Commands.Definitions.SocialMedia.Update;
using GCard.Application.Features.Queries.Definitions.SocialMedia.GetAll;
using GCard.Application.Features.Queries.Definitions.SocialMedia.GetById;
using MediatR;
