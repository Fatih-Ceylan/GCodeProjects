...
using GCard.Application.Features.Commands.Definitions.Cargo.Delete;
using GCard.Application.Features.Commands.Definitions.Cargo.Update;
using GCard.Application.Features.Queries.Definitions.Cargo.GetAll;
using GCard.Application.Features.Queries.Definitions.Cargo.GetById;
using MediatR;
