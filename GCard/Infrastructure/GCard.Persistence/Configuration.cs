...
namespace GCard.Persistence
{
    ...
    {
        static public List<(string server, string database, string userId, string password)> GCardConnectionString
        {
            get
            {
                ...
                connectionDatas.Add((configurationManager.GetConnectionString("Server"),
                                    configurationManager.GetConnectionString("GCardDatabase"),
