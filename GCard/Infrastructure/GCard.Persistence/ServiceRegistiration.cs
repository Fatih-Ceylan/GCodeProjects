...
using GCard.Application.Abstractions.Mail;
...
using GCard.Persistence.Mail;
using GCard.Persistence.Repositories.ReadRepository;
using GCard.Persistence.Repositories.ReadRepository.Files;
using GCard.Persistence.Repositories.WriteRepository;
using GCard.Persistence.Repositories.WriteRepository.Files;
using GCard.Persistence.Services;
...
namespace GCard.Persistence
{
    public static class ServiceRegistiration
    {
        public static void AddGCardPersistenceServices(this IServiceCollection services)
        {
