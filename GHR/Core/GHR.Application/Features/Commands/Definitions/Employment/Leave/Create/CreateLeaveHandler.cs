...
namespace GHR.Application.Features.Commands.Definitions.Employment.Leave.Create
{
    public class CreateLeaveHandler : IRequestHandler<CreateLeaveRequest, CreateLeaveResponse>
    {
        ...
        {
            var leave = _mapper.Map<BaseProject.Domain.Entities.GHR.Employment.Leave>(request);
