...
namespace GHR.Application.Features.Commands.Definitions.Employment.EducationInfo.Create
{
    public class CreateEducationInfoHandler : IRequestHandler<CreateEducationInfoRequest, CreateEducationInfoResponse>
    {
        ...
        {
            var educationInfo = _mapper.Map<BaseProject.Domain.Entities.GHR.Employment.EducationInfo>(request);
