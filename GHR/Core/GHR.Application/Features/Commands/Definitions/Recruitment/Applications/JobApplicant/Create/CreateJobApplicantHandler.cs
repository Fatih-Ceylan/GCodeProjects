...
namespace GHR.Application.Features.Commands.Definitions.Recruitment.Applications.JobApplicant.Create
{
    public class CreateJobApplicantHandler : IRequestHandler<CreateJobApplicantRequest, CreateJobApplicantResponse>
    {
        ...
        {
            var jobApplicant = _mapper.Map<BaseProject.Domain.Entities.GHR.Recruitment.Applications.JobApplicant>(request);
