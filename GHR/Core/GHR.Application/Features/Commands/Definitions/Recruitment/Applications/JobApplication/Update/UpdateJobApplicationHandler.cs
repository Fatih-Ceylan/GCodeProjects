...
using T = BaseProject.Domain.Entities.GHR.Recruitment.Applications;

namespace GHR.Application.Features.Commands.Definitions.Recruitment.Applications.JobApplication.Update
{
