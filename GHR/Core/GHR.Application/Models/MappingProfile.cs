...
using GHR.Application.Features.Commands.Definitions.Employment.Appellation.Create;
using GHR.Application.Features.Commands.Definitions.Employment.Appellation.Update;
using GHR.Application.Features.Commands.Definitions.Employment.EducationInfo.Create;
using GHR.Application.Features.Commands.Definitions.Employment.EducationInfo.Update;
using GHR.Application.Features.Commands.Definitions.Employment.Employee.Create;
using GHR.Application.Features.Commands.Definitions.Employment.Employee.Update;
using GHR.Application.Features.Commands.Definitions.Employment.Leave.Create;
using GHR.Application.Features.Commands.Definitions.Employment.Leave.Update;
using GHR.Application.Features.Commands.Definitions.Employment.LeaveType.Create;
using GHR.Application.Features.Commands.Definitions.Employment.LeaveType.Update;
using GHR.Application.Features.Commands.Definitions.Employment.Payroll.Create;
using GHR.Application.Features.Commands.Definitions.Employment.Payroll.Update;
using GHR.Application.Features.Commands.Definitions.Recruitment.Applications.JobApplicant.Create;
using GHR.Application.Features.Commands.Definitions.Recruitment.Applications.JobApplicant.Update;
using GHR.Application.Features.Commands.Definitions.Recruitment.Applications.JobApplication.Create;
using GHR.Application.Features.Commands.Definitions.Recruitment.Applications.JobApplication.Update;
using GHR.Application.Features.Commands.Definitions.Recruitment.Applications.JobApplicationStatus.Create;
using GHR.Application.Features.Commands.Definitions.Recruitment.Jobs.JobAdvert.Create;
using GHR.Application.Features.Commands.Definitions.Recruitment.Jobs.JobAdvert.Update;

namespace GHR.Application.Models
{
